...
const JobCardForm = ({
  ...
  const [jobDatePopoverOpen, setJobDatePopoverOpen] = useState(false);
  const [estimatedDatePopoverOpen, setEstimatedDatePopoverOpen] = useState(false);
  ...
  const handleJobDateChange = (date: Date | undefined) => {
    ...
    onChange(syntheticEvent as any);
    setJobDatePopoverOpen(false); // Close popover after selection
  };

  const handleEstimatedDateChange = (date: Date | undefined) => {
    if (!date) return;
    const syntheticEvent = {
      target: {
    ...
    onChange(syntheticEvent as any);
    setEstimatedDatePopoverOpen(false); // Close popover after selection
  };
              ...
              <div className="grid gap-6">
                ...
                <div className="grid grid-cols-4 gap-4">
                  <div className="space-y-2">
                    ...
                    <Popover open={jobDatePopoverOpen} onOpenChange={setJobDatePopoverOpen}>
                      ...
                      <PopoverContent className="w-auto p-0 z-50 bg-white shadow-lg pointer-events-auto">
                        <Calendar
                          mode="single"
                  ...
                  <div className="space-y-2">
                    ...
                    <Popover open={estimatedDatePopoverOpen} onOpenChange={setEstimatedDatePopoverOpen}>
                      <PopoverTrigger asChild>
                        <Button
                          variant="outline"
                          className="w-full justify-start text-left font-normal"
                      ...
                      <PopoverContent className="w-auto p-0 z-50 bg-white shadow-lg pointer-events-auto">
                        <Calendar
                          ...
                          onSelect={handleEstimatedDateChange}
                          initialFocus
                          className="p-3 pointer-events-auto"
                        />
                      </PopoverContent>
